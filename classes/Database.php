...
if (!defined('BASEURL')) exit('No Direct access to page');
...
class Database extends PDO
{
     ...
     */
    public function insert($table, $data, $return_insert_id = '')
    {
        ksort($data);
        ...
        foreach ($data as $key => $value) {
         ...
         $sth->execute();
         if(!empty($return_insert_id)) return PDO::lastInsertId();
         return true;
    }
    ...
    public function fetchData($table, $params = array())
    {
        $DbClass                        = new DbClass;
